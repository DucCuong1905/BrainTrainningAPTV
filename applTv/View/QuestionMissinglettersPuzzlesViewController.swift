//
//  QuestionMissinglettersPuzzlesViewController.swift
//  applTv
//
...
class QuestionMissinglettersPuzzlesViewController: UIViewController {
    var ourTimer = Timer()
    ...
    func getHomeNimeManga() {
        APIService.shared.GetAllQuestionMissingPuzzles() { [self] (response, error) in
    ...
    func loadQuestion(){
        ...
        let answerRD =  ["M", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "A", "S", "D", "F", "G", "H", "J", "K", "L", "Z", "X", "C", "V", "B", "N"]
        ...
        if randomAnswer == 0{
            ...
            outletBTB.setTitle(ard3, for: .normal)
            ...
            outletBTB.setTitle(ard2, for: .normal)
            outletBTC.setTitle(ard3, for: .normal)
            outletBTD.setTitle(ard, for: .normal)
        }else if randomAnswer == 2{
            outletBTA.setTitle(ard, for: .normal)
            ...
            outletBTA.setTitle(ard2, for: .normal)
            outletBTB.setTitle(ard3, for: .normal)
            outletBTC.setTitle(ard, for: .normal)
