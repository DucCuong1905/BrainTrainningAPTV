//
//  QuestionChemistryViewController.swift
//  applTv
//
...
import UIKit
import Kingfisher
class QuestionChemistryViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionChemistry() { [self] (response, error) in
