//
//  QuestionWorldGeographyViewController.swift
//  applTv
//
...
class QuestionWorldGeographyViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionWorldGeography() { [self] (response, error) in
