//
//  QuestionNationalLatestCurrentAffairsViewController.swift
//  applTv
//
...
import UIKit
import Kingfisher
class QuestionNationalLatestCurrentAffairsViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionNationalLatestCurrentAffairs() { [self] (response, error) in
