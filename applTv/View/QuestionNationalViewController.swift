//
//  QuestionNationalViewController.swift
//  applTv
//
...
class QuestionNationalViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionNational() { [self] (response, error) in
