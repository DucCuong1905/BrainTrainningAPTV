//
//  QuestionSpottingErrorsViewController.swift
//  applTv
//
...
class QuestionSpottingErrorsViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionSpottingErrors() { [self] (response, error) in
