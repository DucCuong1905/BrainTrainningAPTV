//
//  QuestionAgricultureLatestCurrentAffairsViewController.swift
//  applTv
//
...
import UIKit
import Kingfisher
class QuestionAgricultureLatestCurrentAffairsViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionAgricultureLatestCurrentAffairs() { [self] (response, error) in
