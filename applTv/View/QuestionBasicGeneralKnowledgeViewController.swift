//
//  QuestionBasicGeneralKnowledgeViewController.swift
//  applTv
//
...
class QuestionBasicGeneralKnowledgeViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionBasicGeneralKnowledge() { [self] (response, error) in
