//
//  QuestionAntonymsViewController.swift
//  applTv
//
...
class QuestionAntonymsViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionAntonyms() { [self] (response, error) in
