//
//  QuestionIndianPoliticsViewController.swift
//  applTv
//
...
class QuestionIndianPoliticsViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionIndianPolitics() { [self] (response, error) in
