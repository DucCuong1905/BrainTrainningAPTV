//
//  QuestionInternationalLatestCurrentAffairsViewController.swift
//  applTv
//
...
import UIKit
import Kingfisher
class QuestionInternationalLatestCurrentAffairsViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionInternationalLatestCurrentAffairs() { [self] (response, error) in
