//
//  QuestionNumberSeriesViewController.swift
//  applTv
//
...
class QuestionNumberSeriesViewController: UIViewController {
    var ourTimer = Timer()
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionNumberSeries() { [self] (response, error) in
