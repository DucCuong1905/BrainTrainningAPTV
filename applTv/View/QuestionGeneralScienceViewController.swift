//
//  QuestionGeneralScienceViewController.swift
//  applTv
//
...
import UIKit
import Kingfisher
class QuestionGeneralScienceViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionGeneralScience() { [self] (response, error) in
