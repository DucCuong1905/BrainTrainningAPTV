//
//  QuestionSpellingsViewController.swift
//  applTv
//
...
class QuestionSpellingsViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionSpellings() { [self] (response, error) in
