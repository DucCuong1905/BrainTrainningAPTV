//
//  QuestionMatchingDefinitionsViewController.swift
//  applTv
//
...
class QuestionMatchingDefinitionsViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionMatchingDefinitions() { [self] (response, error) in
