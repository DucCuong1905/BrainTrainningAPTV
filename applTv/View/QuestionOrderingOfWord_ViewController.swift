//
//  QuestionOrderingOfWord_ViewController.swift
//  applTv
//
...
class QuestionOrderingOfWord_ViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionOrderingOfWords() { [self] (response, error) in
