//
//  QuestionAnalogiesViewController.swift
//  applTv
//
...
class QuestionAnalogiesViewController: UIViewController {
    var ourTimer = Timer()
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionAnalogies() { [self] (response, error) in
