//
//  QuestionLogicalPuzzles_ViewController.swift
//  applTv
//
...
class QuestionLogicalPuzzles_ViewController: UIViewController {
    ...
    func getHomeNimeManga() {
        APIService.shared.GetAllLogicalPuzzles() { [self] (response, error) in
    ...
    func loadQuestion(){
        ...
        let answerRD = ["M", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "A", "S", "D", "F", "G", "H", "J", "K", "L", "Z", "X", "C", "V", "B", "N", "M"]
