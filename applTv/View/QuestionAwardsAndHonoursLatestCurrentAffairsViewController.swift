//
//  QuestionAwardsAndHonoursLatestCurrentAffairsViewController.swift
//  applTv
//
...
import UIKit
import Kingfisher
class QuestionAwardsAndHonoursLatestCurrentAffairsViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionAwardsAndHonoursLatestCurrentAffairs() { [self] (response, error) in
