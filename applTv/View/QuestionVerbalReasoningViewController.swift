//
//  QuestionVerbalReasoningViewController.swift
//  applTv
//
...
class QuestionVerbalReasoningViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionVerbalReasoning() { [self] (response, error) in
