//
//  QuestionSentenceImprovementViewController.swift
//  applTv
//
...
class QuestionSentenceImprovementViewController: UIViewController {
    ...
    var answerABCD: String?
        ...
        func getHomeNimeManga() {
            APIService.shared.GetAllQuestionSentenceImprovement() { [self] (response, error) in
